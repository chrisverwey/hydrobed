...
-- update driver set controller_id=1, i2c_port=1, name='MAIN', location='BACK YARD', schedule_read_freq=600, driver_type=1 where driver_id = 1;
-- update driver set controller_id=1, i2c_port=69, name='POWER', location='BACK YARD', schedule_read_freq=60, driver_type=2 where driver_id = 2;
